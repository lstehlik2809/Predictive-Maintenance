...
# aml_leader <- h2o.loadModel(path = file.path(getwd(), "StackedEnsemble_AllModels_0_AutoML_20180428_182557"))
# 
# # predict test data
...
predict_future <- readRDS(predict_future, "predict_future.RData")
```
